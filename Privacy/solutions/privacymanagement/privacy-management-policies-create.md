...
## <a name="create-a-custom-privacy-management-policy"></a>カスタムのプライバシー管理ポリシーを作成する
...
電子メール通知を送信するプライバシー管理の全体的な機能は、設定。  これは既定では有効になっています。 この設定をオフにすると、通知が個々のポリシー レベルで構成されている場合でも、すべてのメールが停止します。
